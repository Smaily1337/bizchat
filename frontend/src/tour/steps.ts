...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    id: "channels",
    title: "Kanały",
    body: "Podłącz Messenger, Instagram, Telegram i widget WWW. Skopiuj webhooki, wklej w Meta / BotFather i wróć tu po business_id oraz snippet osadzenia.",
    route: "/channels",
  ...
  },
  {
    id: "notifications",
    title: "Powiadomienia",
    body: "Szablony SMS / e-mail / Messenger przypominają o wizycie. Domyślny kanał możesz zmienić per salon.",
    route: "/notifications",
