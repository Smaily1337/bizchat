...
const fieldClass =
  "w-full rounded-control border border-glass-border bg-glass-fill px-3.5 py-2.5 text-sm text-[var(--text-bright)] outline-none backdrop-blur-glass transition placeholder:text-[var(--muted)] focus:border-glass-border focus:bg-glass-fillStrong focus:shadow-active";
