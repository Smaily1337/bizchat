    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-glass-border">
        ...
        <div className="flex flex-wrap items-center gap-1.5 bg-[var(--surface-container)] p-1 rounded-xl border border-glass-border">
          {[
            { id: "send", label: "Wysyłka", icon: "send" },
            { id: "reminders", label: "Przypomnienia", icon: "alarm" },
            { id: "templates", label: "Szablony", icon: "description" },
            { id: "log", label: "Historia", icon: "history" },
          ].map((tab) => (
            <Link
              key={tab.id}
      ...
      {!active && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-up">
          <Link to="/notifications/send" className="glass-panel glass-panel-interactive rounded-xl p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--muted)]">Ręczna wysyłka wiadomości i powiadomień</p>
            </div>
          </Link>
          <Link to="/notifications/reminders" className="glass-panel glass-panel-interactive rounded-xl p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--muted)]">Automatyczne reguły i lead times</p>
            </div>
          </Link>
          <Link to="/notifications/templates" className="glass-panel glass-panel-interactive rounded-xl p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[var(--secondary)]/10 flex items-center justify-center text-[var(--secondary)] shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--muted)]">Zarządzaj treściami z podglądem na żywo</p>
            </div>
          </Link>
          <Link to="/notifications/log" className="glass-panel glass-panel-interactive rounded-xl p-5 flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center text-[var(--accent)] shrink-0">
              <span className="material-symbols-outlined text-[26px]">history</span>
            </div>
            <div>
              <p className="font-semibold text-[var(--text-bright)]">Historia</p>
              <p className="text-xs text-[var(--muted)]">Rejestr i logi wysłanych wiadomości</p>
            </div>
          </Link>
        </div>
      )}
